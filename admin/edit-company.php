...
// Fetch company data
$company_query = "SELECT c.*, u.username, u.email as user_email 
                 FROM companies c
...
if ($company_stmt) {
    ...
    // Set variables from company data
    ...
    $current_logo = $company_data['logo'];
    ...
    $user_email = $company_data['user_email'];
} else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Handle logo upload
    $logo = $current_logo; // Keep existing logo by default
        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            if ($_FILES['logo']['size'] > $max_size) {
                ...
                if (move_uploaded_file($_FILES['logo']['tmp_name'], $upload_path)) {
                    ...
                    if (!empty($current_logo) && $current_logo !== 'default-company.png' && file_exists($upload_dir . $current_logo)) {
    ...
    if (empty($errors)) {
        ...
        if ($update_stmt) {
            ...
            if ($update_stmt->execute()) {
                ...
                $errors[] = "Error updating company: " . $update_stmt->error;
            }
        } else {
            $errors[] = "Error preparing statement: " . $conn->error;
        }
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><?php echo $page_title; ?>: <?php echo htmlspecialchars($company_name); ?></h1>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="edit-company.php?id=<?php echo $company_id; ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="row mb-4">
                                <div class="col-12">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="user_account" value="<?php echo htmlspecialchars($username . ' (' . $user_email . ')'); ?>" readonly>
                                    <div class="form-text">Associated user account (cannot be changed)</div>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select" id="company_size" name="company_size">
                                        ...
                                        <option value="1001+" <?php echo ($company_size == '1001+') ? 'selected' : ''; ?>>1001+ employees</option>
                                    </select>
                                </div>
                                
                                <div class="col-md-4 mb-3">
                                    <label for="founded_year" class="form-label">Founded Year</label>
                                    <input type="number" class="form-control" id="founded_year" name="founded_year" min="1800" max="<?php echo date('Y'); ?>" value="<?php echo htmlspecialchars($founded_year ?? ''); ?>">
                                </div>
                                
                                <div class="col-md-12 mb-3">
                                    <label for="company_description" class="form-label">Company Description</label>
                                    <textarea class="form-control summernote" id="company_description" name="company_description" rows="5"><?php echo htmlspecialchars($company_description ?? ''); ?></textarea>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="mb-2">
                                        <img src="<?php echo file_exists('../uploads/companies/' . $current_logo) ? '../uploads/companies/' . htmlspecialchars($current_logo) : '../assets/img/default-company.png'; ?>" alt="Current Logo" class="img-thumbnail" style="max-height: 100px;">
                                    ...
                                    <div class="form-text">Max size: 2MB. Allowed formats: JPG, PNG, GIF. Leave empty to keep current logo.</div>
                                </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="url" class="form-control" id="facebook_url" name="facebook_url" value="<?php echo htmlspecialchars($facebook_url ?? ''); ?>" placeholder="https://facebook.com/company">
                                </div>
                                
                                <div class="col-md-4 mb-3">
                                    <label for="twitter_url" class="form-label">Twitter URL</label>
                                    <input type="url" class="form-control" id="twitter_url" name="twitter_url" value="<?php echo htmlspecialchars($twitter_url ?? ''); ?>" placeholder="https://twitter.com/company">
                                </div>
                                
                                <div class="col-md-4 mb-3">
                                    <label for="linkedin_url" class="form-label">LinkedIn URL</label>
                                    <input type="url" class="form-control" id="linkedin_url" name="linkedin_url" value="<?php echo htmlspecialchars($linkedin_url ?? ''); ?>" placeholder="https://linkedin.com/company/name">
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_verified" name="is_verified" <?php echo ($is_verified) ? 'checked' : ''; ?>>
